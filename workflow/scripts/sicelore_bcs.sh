...
grep -f sicelore_ill/barcodes.csv umifinder_ill/BarcodesAssigned.tsv | cut -f 1-2 | sed 's/,//' | awk '{print $1"-1", "0", $2,"sicelore_v210+ill"}' OFS="\t" >> cb.tsv
...
grep -f sicelore_noill/barcodes.csv umifinder_noill/BarcodesAssigned.tsv | cut -f 1-2 | sed 's/,//' | awk '{print $1"-1", "0", $2,"sicelore_v210"}' OFS="\t" >> cb.tsv
